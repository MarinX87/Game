...
HRESULT InitTree(void)
{
	...
	// 木の設定
	SetTree(XMFLOAT3(100.0f, 0.0f, -5.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3(200.0f, 0.0f, 0.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3(-200.0f, 0.0f, 0.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3(-300.0f, 0.0f, 500.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	SetTree(XMFLOAT3(0.0f, 0.0f, -200.0f), 60.0f, 90.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	//SetTree(XMFLOAT3(0.0f, 80.0f,0.0f), 3840000.0f, 2160000.0f, XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	return S_OK;
}
